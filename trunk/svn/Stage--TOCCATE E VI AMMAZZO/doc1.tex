...
La fase di lettura vera e propria viene effettuata dal metodo ricorsivo read che prende due parametri:
\begin{itemize}
\item [tree:Tree] Ossia un nodo dell'AST del quale si analizzeranno i figli;
\item [root:Element] Ossia un Elemento DOM che teoricamente dovrebbe essere descritto da tree.
\end{itemize}
...
Qualora non fosse un array allora e' un oggetto oppure un elemento atomico:
