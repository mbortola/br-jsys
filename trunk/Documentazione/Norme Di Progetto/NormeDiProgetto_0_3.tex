...
I commenti di documentazione devono descrivere classi, interfacce, costruttori, metodi e campi dato. Ogni commento di documentazione deve essere situato all'interno dei delimitatori /**...*/ e ci deve essere un solo commento per ogni classe, interfaccia o membro. Non devono essere posizionati all'interno del blocco di definizione di un metodo o di un costruttore. Questo tipo di commento deve apparire subito prima della dichiarazione:
