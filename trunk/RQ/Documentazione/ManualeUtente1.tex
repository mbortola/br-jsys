...
\item Se la \underline{business rule} risulta presente nel \rp\, comparir\`a  nel campo ``Details'' i suoi dettagli (Nome, BO Associato, Regola, Commento) figura 3.3.2. 
...
\includegraphics[width=0.7\textwidth]{manuale_utente/errore_repository_vuoto.eps}\\
 figura 3.3.7 messaggio di repository vuoto.
\end{center} 
La figura 3.3.7 mostra l'esito di un'errata rimozione di \underline{business rules}. La \underline{business rule} non pu\`o essere rimossa dal \rp\ in quanto il repository non contiene alcuna.
