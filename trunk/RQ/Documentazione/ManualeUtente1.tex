...
%  figura 3.0.2: esempio di username o password errati
% \end{center} 
...
% \begin{center}
% \includegraphics[width=0.5\textwidth]{}\\
%  figura 3.3.4 messaggio di br rimossa
% \end{center} 
% La figura 3.3.4 mostra la conferma di rimozione di business rules. La business rule \`e stata trovata dal repository.
...
\begin{center}
\includegraphics[width=0.9\textwidth]{manuale_utente/esempio_errore_sandbox_query_errata.eps}\\
