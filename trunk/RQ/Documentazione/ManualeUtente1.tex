...
\item un insieme di regole collegate tra loro attraverso operatori booleani (AND \textbar OR).
\end{itemize}
\subsection{Struttura regola}
Ogni singola regola \`e formata da espressioni collegate tra loro attaverso operatori di confronto (= \textbar != \textbar \textless \textbar \textgreater \textbar \textless= \textbar \textgreater=). Alla regola pu\`o venire associato un ``message'' (opzionale), col compito di fornire informazioni aggiuntive sullo stato di validazione della business rule. 
\subsection{Struttura espressione}
Una espressione \`e formata da campi dati che posso essere di 3 tipi diversi:
\begin{itemize}
\item Float;
\item Bool;
\item String. 
...
Float permette le operazioni di:
\begin{itemize}
\item[-] addizione;
\item[-] sottrazione;
...
Bool permette le operazioni di:
\begin{itemize}
\item[-] NOT;
\item[-] %&&;
\item[-] ||.
...
String permette invece solo le operazioni di confronto.
...
\includegraphics[width=0.5\textwidth]{manuale_utente/login.eps}\\
 \caption{figura 3.0: schermata di login}
\end{center}
...
\includegraphics[width=0.5\textwidth]{manuale_utente/schermata_principale.eps}\\
 \caption{figura 3.1: schermata principale}
\end{center}
...
\includegraphics[width=0.6\textwidth]{manuale_utente/schermata_inserimento.eps}\\
 \caption{figura 3.3: schermata di inserimento}
\end{center}
...
\includegraphics[width=0.6\textwidth]{manuale_utente/schermata_rimozione.eps}\\
 \caption{figura 3.4: schermata di rimozione}
\end{center}
...
\begin{center}
 ...
 \caption{figura 3.5: schermata sandbox}
\end{center}
