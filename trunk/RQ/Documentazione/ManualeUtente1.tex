...
Una volta installate tutte le componenti necessarie, si pu\`o procedere all'avvio dell'applicazione. Apparir\`a la schermata iniziale (Gui), nella quale l' utente che accede per la prima volta al servizio dovr\`a digitare i dati di login:\\ 
\begin{itemize}
\item username:root 
\item password:root
\end{itemize}
