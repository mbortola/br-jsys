...
\hyphenation{glos-sa-rio si-ste-ma ar-chi-vio }
...
Regola \textless nome regola\textgreater\  gi\`a presente & La regola ha un nome gi\`a presente nel repository. \\ \hline
\end{tabular} \\
\end{table}
