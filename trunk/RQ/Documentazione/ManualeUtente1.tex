...
Un message pu\`o formato da:
\begin{itemize}
\item tutte le lettere maiuscole dalla A alla Z;
\item tutte le lettere minuscole dalla a alla z;
\item tutti i numeri da 0 a 9;
\item spazi vuoti;
\item i seguenti caratteri di punteggiatura: . \textbar\ ? \textbar\ ! \textbar\ - \textbar\ ~ \textbar\ _ \textbar\ ^. 
\end{itemize}
...
\end{center} % questo deve essere il disegno dei messaggi sia di esito positivo che di negativo: quindi 2 disegni
