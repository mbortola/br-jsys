...
Campo dato \textless nome campo dato\textgreater\ non trovato & Riferimento ad un campo dato sbagliato. \\ \hline
Operazione non consentita: \textless tipo 1\textgreater\ != \textless tipo 2\textgreater\ al punto <token dove è avvenuto l'errore> & Errore tra tipi. Esecuzione di un'operazione di confronto tra due tipi diversi. \\ \hline
Errore sintattico al punto \textless punto di errore\textgreater\ & Errore di scrittura. \\ \hline
Regola \textless nome regola\textgreater\  gi\`a presente & La regola ha un nome gi\`a presente nel repository.
\end{tabular} \\
\end{table}
