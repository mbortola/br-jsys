...
Per utilizzare il prodotto \`e necessario che venga installato sulla macchina il server eXist.
Ecco come installare passo per passo eXist:
\begin{itemize}
\item[1-] Entrare nella directory contenente il file di installazione \textbf{eXist-setup-1.2.0-rev7233.jar} (METTERE NOME DIRECTORY CHE ORA NON SO);
\item[2-] Cliccare con il tasto destro del mouse sul file di installazione e aprirlo con Java 6 Runtime come mostrato in figura;
\begin{center}
\includegraphics[width=0.5\textwidth]{manuale_utente/installazione_Exist0.eps}\\
\end{center}
\item[3-] A questo punto inizier\'a l'installazione vera e propria. Cliccare sul tasto ``Next`` per proseguire o su ''Quit`` per terminare l'installazione;
\begin{center}
\includegraphics[width=0.9\textwidth]{manuale_utente/installazione_Exist1.eps}\\
\end{center}
\item[4-] Selezionare i pacchetti che si desidera installare (\'e consigliabile lasciare quelli  di default) e premere sul tasto ``Next`` per proseguire, su ''Previous`` per tornare al passo precedente o su ''Quit`` per terminare l'installazione;
\begin{center}
\includegraphics[width=0.9\textwidth]{manuale_utente/installazione_Exist2.eps}\\
\end{center}
\item[5-] Selezionare la directory nella quale si desidera installare eXist (o lasciare quella di default) e premere sul tasto ``Next`` per proseguire, su ''Previous`` per tornare al passo precedente o su ''Quit`` per terminare l'installazione;
\begin{center}
...
\item[3-] Da shell di Linux: bin/startup.sh. Dal prompt dei comandi: ''bin\startup.bat'';
\end{itemize}	
