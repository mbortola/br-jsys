...
\subsection{Nome}
Il nome della \br che l'utente intende inserire. Il nome della \br deve essere univoco all'interno del repository

\subsection{Business Object Associato}
Il \bo al quale si vuole associare la regola.
