...
Oggetto associato <nome associato> inesistente! & Inserimento di una business rule con un business object associato non valido.  \\ \hline
Campo dato <nome campo dato> non trovato! & Riferimento ad un campo dato sbagliato. \\ \hline
Operazione non consentita: <tipo 1>!=<tipo 2> al punto <token dove è avvenuto l'errore> & Errore tra tipi. Esecuzione di un'operazione di confronto tra due tipi diversi. \\ \hline
Errore sintattico al punto <punto di errore> & Errore di scrittura. \\ \hline
Regola <nome regola > gi\`a presente! & La regola ha un nome gi\`a presente nel repository.
\end{tabular} \\
\end{table}
