...
\end{center} 
La figura 3.2.7 mostra l'esito di un errato inserimento di business rules. La business rule non pu\`o essere validata e inserita nel \rp\ in quanto il testo della \br\ \`e gi\`a presente.
...
\item Se la business rule risulta presente nel \rp\, comparir\`a  nel campo ``Details'' i suoi dettagli (Nome, BO Associato, Regola, Commento) figura 3.3.1. 
...
\end{itemize}
\section{Esempi di business rules}
