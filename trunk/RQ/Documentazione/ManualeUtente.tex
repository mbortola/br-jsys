...
\includegraphics[width=0.7\textwidth]{manuale_utente/errore_campodati.eps}\\
 figura 3.2.9: esempio inserimento campo dati non presente nel \bo associato
\end{center} 
La figura 3.2.9 mostra l'esito di un errato inserimento di business rules. La business rule non pu\`o essere validata e inserita nel \rp\ in quanto il campo dati della \br\ non \`e presente nel \bo associato.
