...
\end{center} 
La figura 3.2.6 mostra l'esito di un errato inserimento di business rules. La business rule non pu\`o essere validata e inserita nel \rp\ in quanto vi \`e gi\`a un'occorrenza di questa nel \rp.
...
\end{center} 
La figura 3.2.7 mostra l'esito di un errato inserimento di \underline{business rules}. La business rule non pu\`o essere validata e inserita nel \rp\ in quanto il testo della \br\ \`e gi\`a presente.
...
Una \br\ pu\`o contenere confronti tra booleani. Ad esempio ``difettoso=false''. Il campo dati deve essere un booleano e pu\`o essere confrontato solo con altri campi dati dello stesso tipo o con valori come ``true'' e ``false''.
%controllare qusta parte
