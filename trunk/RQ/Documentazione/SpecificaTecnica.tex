...
\section{Interprete}
\subsubsection{Tipo, obiettivo e funzione del componente}
Questo componente si incarica di eseguire le \brs\ associate ad un determinato \bo. Per ottenere le \brs, deve poter interrogare il DBMS attraverso un opportuna interfaccia col sistema \underline{BR-jsys} che risolver\`a per lui la richiesta.
\subsubsection{Relazioni d'uso di altre componenti}
...
\begin{center}
 \includegraphics[width=1.3\textwidth, angle=-90]{activity-dia/InserisciBusinessRule.eps}
\end{center}
