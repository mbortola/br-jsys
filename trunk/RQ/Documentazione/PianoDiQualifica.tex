...
%-------------------------------------------------------------------------------diario modifiche
1.9 & 07/03/2008 & \ET & Correzione documento.\\ \hline
...
\item utilizzando \underline{stub} per quanto riguarda la Gui. 
\end{itemize}
...
\begin{tabular}{||p{4cm}||p{8cm}||}
\hline
{\textbf {Obiettivo Prova:}}& Testare il corretto inserimento delle \underline{business rules} nel \underline{repository}\\ \hline
{\textbf{Dipendenze:}}& F2 \\ \hline
{\textbf{Descrizione Prova}}&  Inserimento di varie \underline{business rules} d'appoggio gi\`a validate e controllo all'interno del \underline{repository} dell'avvenuto inserimento\\ \hline
...
\begin{tabular}{||p{4cm}||p{8cm}||}
\hline
{\textbf {Obiettivo Prova:}}& Testare l'efficienza in termini di tempo di risposta del \underline{DBMS} di appoggio al \underline{repository} \\ \hline
...
{\textbf{Dipendenze:}}& nessuna \\ \hline
{\textbf{Descrizione Prova:}}&  Recuperare dal \underline{repository} tutte le \underline{business rules} associate ad un determinato \underline{business object}\\ \hline
...
\begin{tabular}{||p{4cm}||p{8cm}||}
\hline
{\textbf {Obiettivo Prova:}}& Testare la correttezza della cancellazione di una \underline{business rule} dal \underline{repository} e controllo dei risultati ottenuti\\ \hline
{\textbf{Dipendenze:}}& nessuna \\ \hline
{\textbf{Descrizione Prova:}}&  Richiesta al \underline{DBMS} di cancellare varie \underline{business rules} date in input dal \underline{repository}. Si tester\`a la correttezza dell'eliminazione fatta. Ogni eliminazione riuscita o meno dovr\`a essere accompagnata da una chiara notifica di evento\\ \hline
...
{\textbf{Descrizione Prova:}}& Si creer\`a  una semplice interfaccia in linguaggio Java, con le componenti essenziali per permettere l' inserimento/rimozione di una \underline{business rule} nel \underline{repository} e la successiva notifica di tale evento \\ \hline
...
\begin{tabular}{||p{4cm}||p{8cm}||}
\hline
{\textbf{Obiettivo Prova:}}& Il formato di salvataggio delle \underline{business rules} e del \underline{repository} dovr\`a essere XML.\\ \hline
{\textbf{Dipendenze:}}& nessuna \\ \hline
...
{\textbf{Output:}}& L'inserimento della \underline{business rule} in formato XML nel \underline{repository} \\ \hline
\end{tabular} \\
\\
\\
...
{\textbf{Dipendenze:}}& nessuna \\ \hline
{\textbf{Descrizione Prova:}}& Popolamento del \underline{repository} attraverso inserimento di \underline{business rules} d'appoggio e interazioni con esso. Si valuter\`a l'efficienza, in termini di tempo di risposta, del \underline{DBMS} usato  \\ \hline
...
\begin{tabular}{||p{4cm}||p{8cm}||}
\hline
{\textbf{Obiettivo Prova:}}& Rendere univoca l'identificazione delle \underline{business rules} all'interno del \underline{repository} \\ \hline
{\textbf{Dipendenze:}}& nessuna \\ \hline
{\textbf{Descrizione Prova:}}& Inserimento di varie \underline{business rules} d'appoggio nel \underline{repository} e controllo dell'unicit\`a della loro indicizzazione \\ \hline
...
{\textbf{Descrizione Prova:}}& Si applicheranno a \underline{business objects} esistenti tutte le operazioni che il linguaggio permette e si valuter\`a l'esito della validazione di tali operazioni, confrontandoli con i risultati aspettati.  \\ \hline
