...
\chapter{Analisi Statica del codice}210.96
...
% white box è una tecnica di progettazione non di esecuzione dei test i test si eseguono sul codice. la loro progettazione può essere fatta alla cazzo black box o basandosi sulla conoscenza del sorgente whitebox
Questa componente verr\`a testata inserendo in input al validatore un oggetto \br\,  con gli attributi di seguito specificati, e confrontando l'output del validatore con l'output atteso. Attraverso questi test verr\`a valutato il corretto comportamento del programma dinnanzi situazioni limite. I test di seguito illustrati sono stati progettati a a scatola aperta (\underline{whitebox}), basandosi sull'analisi del codice sorgente.\\
\\
...
Si testa una \br\ semplice per verificare che il commento pu\`o non essere inserito. E se non inserito non compare come attributo vuoto nell' \underline{XML}.\\
...
\begin{tabular}{|p{11cm}|} \hline
\textbf{Output atteso}\\ \hline
\textless BusinessRule associated=``Articolo'' name=``BR'' rule=``entrate=3; AND uscite=4;''\textgreater \\
...
Si deve testare l'impedimento da parte del validatore di inserire nel \rp\ una \br\ con lo stesso nome. Per fare ci\`o si riesegue l'inserimento della \br\ sopra illustrata e si testa che il valore ritornato sia 'false'.
Requisiti soddisfatti dall'esecuzione: NPr2.\\
 \\

\begin{Large}\textbf{CVT1c}\end{Large} \\
...
NPr2 &  CVT1a, CVT1b, CVT1c, VT8b, VT8c, CT1, CT2, CT3, CT4, CT5 \\ \hline
NQ1 & VT8b, VT8c  \\ \hline
NQ2 &  - \\ \hline
NQ3 &  - \\ \hline
\end{tabular} \\
