...
Requisiti soddisfatti dall'esecuzione: F3,F5,F7,F8,NPo1,NPr2
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
...
\begin{tabular}{|p{11cm}|} \hline
\textbf{Output Atteso}\\ \hline
Deve essere visibile la concatenazione del nome della regola seguito dalla regola stessa\\ \hline
\end{tabular} \\
\end{center}
