...
% for $br in //BusinessRule[starts-with(@name,'i')] return $br
...
%for $br in //BusinessRule[@name='prova'] return update delete $br;
%for $br in //BusinessRule[@associated='Articolo' and not(@comment)] return concat($br[@name], $br[@rule])
