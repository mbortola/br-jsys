...
Commento & Commento\\ \hline
Business object associato & BO \\ \hline
Regola & x=5 AND x=15 OR x=3 AND ( x=2 OR x=12 AND ( x=2 OR (x=4 AND x=3 AND x=3 AND x=4) OR x=2) OR x=5 ( x=3 OR x=2) OR x=7) AND x=12 \\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
...
Commento & Commento\\ \hline
Business object associato & BO \\ \hline
Regola & x=AVG(y)+2 message(``errore nel confronto'')\\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
...
Commento & Commento\\ \hline
Business object associato & BO \\ \hline
Regola & x\textless2 message(``errore nel confronto'')\\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
