...
Si testa una \br\ per verificare che sia possibile fare confroni del tipo '\textless', '\textgreater', '\textless =', '\textgreater =', '=', '!='.\\
Requisiti soddisfatti dall'esecuzione:
\begin{center}
\begin{tabular}{|p{5cm}|p{6cm}|} \hline
\textbf{Attributo \br} & \textbf{Valore} \\ \hline
...
Commento & Commento\\ \hline
Business object associato & Articolo \\ \hline
Regola & (matrice+matrice)+(matrice*matrice)+(matrice/matrice)+(matrice-matrice) \\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
...
Commento & Commento\\ \hline
Business object associato & Articolo \\ \hline
Regola & (matrice+2)+(matrice*3)+(matrice/4)+(matrice-5) \\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
...
Commento & Commento\\ \hline
Business object associato & Articolo \\ \hline
Regola & (matrice+entrate)+(matrice*entrate)+(matrice/entrate)+(matrice-entrate) \\ \hline
\end{tabular} \\
\end{center}
\begin{center}
\begin{tabular}{|p{11cm}|} \hline
