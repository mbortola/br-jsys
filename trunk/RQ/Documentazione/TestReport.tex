...
Si testa che ogni \br\ gi\`a inserita non possa essere inserita con lo stesso nome. Per fare ci\`o si riesegue l'inserimento della \br\ sopra illustrata e si testa che il valore ritornato sia 'false'.
Requisiti soddisfatti dall'esecuzione: \\
 \\
...
VT1e & negativo & \\ \hline
VT1f & negativo & \\ \hline
VT2a & positivo & La parentesizzazione che coinvolge un intera operazione di confronto non \`e ancora stata introdotta nella grammatica del linguaggio. \\ \hline
VT2b & positivo & Un tag che introduce un operazione di confronto deve chiamarsi sempre OBool.\\ \hline
VT2c & negativo & \\ \hline
VT3a & negativo & \\ \hline
VT3b & negativo & \\ \hline
VT4 & negativo & \\ \hline
...
VT18 & positivo & Le stringhe contenti numeri non sono ancora state aggiunte alla grammatica del linguaggio.\\ \hline
VT19 & negativo & \\ \hline
VT20 & negativo & \\ \hline
\end{tabular} \\
\end{center}
...
I \textit{test di convalida} servono ad dimostrare che tutti i requisiti sono stati soddisfatti. Per questo l'esito di un test di convalida \`e segnato come positivo ogniqualvolta dimostra che un requisito \`e soddisfatto, viene altres\`i segnato come negativo l'esito di quei test che hanno fallito.
