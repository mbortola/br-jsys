...
Questa fase verr\`a applicata durante la stesura del codice sorgente per rilevare incongruenze che possono sorgere tra il progetto ed i requisiti, errori, omissioni o anomalie. Verr\`a applicata inoltre sulla struttura delle varie componenti del sistema ``BR-jsys''. Essa comprende le seguenti sottofasi:
\begin{itemize}
