...
\item{}Piano di Qualifica (PianoDiQualifica.1.4.pdf)
\item{}Piano di Progetto (PianoDiProgetto.1.7.pdf)
\item{}Specifica tecnica (SpecificaTecnica.1.0.pdf) 
\item{}Definizione di Prodotto (DefinizioneDiProdotto.0.9.pdf)
\end{itemize}
Per una maggiore completezza e chiarezza dell'offerta, alleghiamo inoltre i seguenti documenti:
\begin{itemize}
\item{}Glossario (Glossario.1.8.pdf)
\item{}Norme di Progetto (NormeDiProgetto.2.0.pdf)
