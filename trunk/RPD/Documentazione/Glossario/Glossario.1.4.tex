...
\newcommand{\lv}{ 1.6 } % latest version
...
\chapter{T}
\section{Token:}
Un blocco di testo categorizzato, scritto in qualsiasi linguaggio e normalmente costituito da caratteri indivisibili chiamati lessemi. L'analizzatore lessicale legge in un flusso di lessemi e li categorizza in token: se esso trova un token non valido, restituisce un errore.
