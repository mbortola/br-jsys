...
\newcommand{\lv}{1.2} % latest version
...
1.3 & 30/01/2008 & Inserimento nuovi vocaboli.\\ \hline
...
Account personale fornito gratuitamente da Google e attivato da ognuno dei membri della HappyCode Inc.
\section{Antlr:}
...
\chapter{E}
\section{Exists:}
omando SQL che specifica una subquery per verificare l'esistenza di righe. Usa una sottoquery come condizione: la condizione è Vera se la sottoquery ritorna almeno una riga, ed è Falsa se la sottoquery non ritorna nessuna riga.
...
\chapter{J}
\section{JUnit:}
\`E un unit test framework pe ril linguaggio di programmazione Java.
\section{J2EE:}
