...
Il seguente docujmento ha lo scopo di descrivere l'architettura logica prodotta al termine della fase di progettazione architetturale, esso descrive in dettaglio i campi dati e i metodi appartenenti alle singole componenti del sistema.
