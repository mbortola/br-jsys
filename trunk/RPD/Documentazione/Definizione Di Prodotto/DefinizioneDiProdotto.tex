...
+getListRules(): String[]& Metodo che ritorna informazioni riguardo le query scritte nel \re. In particolare, l'array di ritorno avr\`a un elemento per ogni \br nel \re. Ogni elemento conterr\`a nome, regola, \bo associato e eventuale commento.\\ \hline
\end{tabular}
\end{center}
