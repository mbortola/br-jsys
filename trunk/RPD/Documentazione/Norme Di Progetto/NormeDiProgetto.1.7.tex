...
Per garantire la correttezza di ogni documento e file condiviso a fronte di cambiamenti (anche simultanei) da parte di tutto il gruppo, verr\`a  utilizzato un server SVN con opportuni client grafici (RapidSVN, KdeSvn). In questo modo verr\`a garantita l'atomicit\`a di ogni aggiornamento inviato al repositoty.\\ 
