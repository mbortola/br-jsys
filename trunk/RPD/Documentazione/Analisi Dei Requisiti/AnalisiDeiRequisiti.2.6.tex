...
\item[NPr2]{Ad ogni business rule deve venir associato un numero identificativo univoco per consentire un'efficiente indicizzazione delle stesse nel repository. [I02]}
\end{itemize}
