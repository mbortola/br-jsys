...
\newcommand{\lv}{2.7} % latest version
...
\par\rule{10cm}{0.4pt} \par {\large Versione 2.7 - \today}
...
%-------------------------------------------------------------------------------diario modifiche
2.7 & 11/02/2008 & Deprecato requisito F9 e modificato i requisiti F4 e F8\\ \hline
2.6 & 04/02/2008 & Correzione grammaticale.\\ \hline
2.5 & 22/01/2008 & Modifica al layout dei documenti e prima correzione grammaticale.\\ \hline
...
0.2 & 22/11/2007 & Aggiornamento  , corequisiti. \\ \hline
...
\underline{Flusso di eventi:} Il sistema  terminata la validazione invia la business rule al DBMS che si preoccuper\`a di inserirla OPZIONALE nel \textit{repository}.\\
...
\item[F8]{Il sistema dovr\`a essere dotato di un'interfaccia grafica minimale che consenta di definire una nuova business rule e una volta validata inserirla nel repository e cancellare business rules dal repository, per  vedere in modo rapido e chiaro il corretto funzionamento del prodotto. [I02]}
