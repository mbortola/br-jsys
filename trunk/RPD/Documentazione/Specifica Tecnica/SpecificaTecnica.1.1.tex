...
\begin{center}
\includegraphics[width=0.4\textwidth, angle=-90]{DiagrammaClassi/gui.eps}
\end{center}
\subsection{Gui}
...
\subsection{Diagramma delle classi}
\begin{center}
\includegraphics[width=0.4\textwidth, angle=-90]{DiagrammaClassi/validator.eps}
\end{center}
...
\subsection{Diagramma delle classi}
\begin{center}
\includegraphics[width=0.3\textwidth, angle=-90]{DiagrammaClassi/Comunicatore.eps}
\end{center}
