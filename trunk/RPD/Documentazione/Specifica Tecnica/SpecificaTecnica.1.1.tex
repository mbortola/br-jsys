...
Viene presentato di seguito un diagramam di collaborazione riguardante le relazioni tra le classi utilizzate nella cancellazione di una \br\ dal \re.
\section{Cancellazione \br}
\begin{center}
 \includegraphics[width=0.7\textwidth, angle=-90]{Cancellazione-cld.eps}
\end{center}
...
\begin{center}
 \includegraphics[width=0.5\textwidth, angle=-90]{Interpretazione-cld.eps}
\end{center}
