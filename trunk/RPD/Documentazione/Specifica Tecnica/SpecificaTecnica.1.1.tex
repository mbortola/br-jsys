...
Il presente documento si ripropone di descrivere il sistema software ``BR-jsys'', sulla base del documento di ``Analisi dei Requisiti'', dal punto di vista architetturale. Lo strumento da noi adottato \`e il linguaggio UML, sottoforma di diagrammi delle classi. L'approccio adottato nell'illustrare il sistema \`e di tipo ``Bottom-up'' Fornir\`a inoltre una visione pi\`u dettagliata delle componenti da realizzare.
...
Questa componente fornisce all'utente un interfaccia minimale, consentendogli di effettuare operazioni di cancellazione e di querying sul \re.
...
\end{center}
La Sandbox \`e una finestra costituita da una 
