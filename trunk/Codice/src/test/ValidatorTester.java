...
public class ValidatorTester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BusinessRule[18] = new BusinessRule("BR","Articolo","(matricePrezzi+matricePrezzi)+(matricePrezzi*matricePrezzi)+(matricePrezzi/matricePrezzi)+(matricePrezzi-matricePrezzi) = 0","Commento");
			BusinessRule[19] = new BusinessRule("BR","Articolo","(matricePrezzi+2) +(matricePrezzi*3) +(matricePrezzi/4) +(matricePrezzi-5) = 0","Commento");
			BusinessRule[20] = new BusinessRule("BR","Articolo","(matricePrezzi+entrate)+(matricePrezzi*entrate)+(matricePrezzi/entrate)+(matricePrezzi-entrate) = 0","Commento");
			BusinessRule[21] = new BusinessRule("BR","Articolo","(matricePrezzi+prezzoBase)+(matricePrezzi*prezzoBase)+(matricePrezzi/prezzoBase)+(matricePrezzi-prezzoBase) = 0","Commento");
			BusinessRule[22] = new BusinessRule("BR","Articolo","(matricePrezzi+grafico)+(matricePrezzi*grafico)+(matricePrezzi/grafico)+(matricePrezzi-grafico) = 0","Commento");
			...
			BusinessRule[28] = new BusinessRule("BR","Articolo","(scontato+3) - (scontato*4)/scontato","Commento");
			BusinessRule[29] = new BusinessRule("BR","Articolo","((scontato||scontato) && scontato) = true AND (true || false && NOT(true))=scontato","Commento");
			BusinessRule[30] = new BusinessRule("BR","Articolo","SUM(prezzoBase) = 12 AND COUNT(entrate)=1, AND AVG(prezzoBase)=4 ","Commento");
			BusinessRule[31] = new BusinessRule("BR","Articolo","SUM(prezzoBase)","Commento");
			BusinessRule[32] = new BusinessRule("BR","Articolo","SUM(prezzoBase)=","Commento");
			BusinessRule[33] = new BusinessRule("BR","Articolo","12 = 2entrate","Commento");
			...
			BusinessRule[41] = new BusinessRule("BR","Articolo","scontato=true +","Commento");
